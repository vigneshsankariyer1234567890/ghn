...
export class RegenerateTables1627301275151 implements MigrationInterface {
    name = 'RegenerateTables1627301275151'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "charityrolelink" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "userroleId" integer NOT NULL, "charityId" integer NOT NULL, "auditstat" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_aa01b2baf292aea1f2d6404ff3e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "userrole" ("id" SERIAL NOT NULL, "roleName" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e4f773b34499eded638ce5fe26b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "eventvolunteer_adminapproval_enum" AS ENUM('pending', 'approved', 'rejected')`);
        await queryRunner.query(`CREATE TABLE "eventvolunteer" ("id" SERIAL NOT NULL, "eventId" integer NOT NULL, "userId" integer NOT NULL, "adminapproval" "eventvolunteer_adminapproval_enum" NOT NULL DEFAULT 'pending', "userroleId" integer NOT NULL, "auditstat" boolean NOT NULL DEFAULT true, "volunteeringCompleted" boolean NOT NULL DEFAULT false, "joinedTelegram" boolean NOT NULL DEFAULT false, "joinedTelegramDate" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_344280cbed72a704dc244309582" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "event" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" text NOT NULL, "dateStart" TIMESTAMP NOT NULL, "dateEnd" TIMESTAMP NOT NULL, "venue" text NOT NULL DEFAULT '', "charityId" integer NOT NULL, "creatorId" integer NOT NULL, "likeNumber" integer NOT NULL DEFAULT '0', "completed" boolean NOT NULL DEFAULT false, "auditstat" boolean NOT NULL DEFAULT true, "telegramGroupId" text, "telegramGroupHash" text, "telegramGroupUpdatedDate" TIMESTAMP WITH TIME ZONE, "imageUrl" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "comment" ("id" SERIAL NOT NULL, "text" character varying NOT NULL, "authorId" integer NOT NULL, "postId" integer NOT NULL, "parentId" integer, "rootId" integer NOT NULL, "auditstat" boolean NOT NULL DEFAULT true, "level" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0b0e4bbc8415ec426f87f3a88e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "post" ("id" SERIAL NOT NULL, "text" character varying NOT NULL, "likeNumber" integer NOT NULL DEFAULT '0', "creatorId" integer NOT NULL, "auditstat" boolean NOT NULL DEFAULT true, "isEvent" boolean NOT NULL DEFAULT false, "imageUrl" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "userprofile" ("id" SERIAL NOT NULL, "about" text NOT NULL, "gender" "userprofile_gender_enum", "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "displayPicture" text, "telegramHandle" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, CONSTRAINT "UQ_fc505bba393243cf1910fca131d" UNIQUE ("userId"), CONSTRAINT "PK_7611eb6ce0cfd2de134000d0b8f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "verified" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "charityfollow" ("id" SERIAL NOT NULL, "charityId" integer NOT NULL, "userId" integer NOT NULL, "auditstat" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7022780bcc7e23235c945e9a65f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "charityprofile" ("id" SERIAL NOT NULL, "about" text NOT NULL, "displayPicture" text, "links" text, "contactNumber" text, "email" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "charityId" integer NOT NULL, CONSTRAINT "UQ_ad5f909c65ea62e8e71cfbaebb2" UNIQUE ("charityId"), CONSTRAINT "PK_6852ad0898240931e7d720d4cc1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "charity" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "uen" character varying NOT NULL, "physicalAddress" character varying NOT NULL, "postalCode" character varying NOT NULL, "charitycreatorId" integer NOT NULL, "followNumber" integer NOT NULL DEFAULT '0', "auditstat" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_ac5d5f85641be5b68ace6a50a0b" UNIQUE ("name"), CONSTRAINT "UQ_ebcf3afeb44ae7b5e59237e4c14" UNIQUE ("uen"), CONSTRAINT "PK_fbdd8ba5b5a6504618b8b1ab295" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "category" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "auditstat" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
